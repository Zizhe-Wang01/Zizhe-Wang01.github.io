...
<div id="notes-editor-create" class="notes-editor-create" hidden>
  <div class="notes-editor-create__heading">
    <div>
      <h2 id="notes-editor-create-heading">内容管理</h2>
      <p id="notes-editor-create-description"></p>
    </div>
    <button id="notes-editor-create-cancel" class="md-button" type="button">取消</button>
  </div>

  <div id="notes-editor-article-fields" hidden>
    <label for="notes-editor-section">所属目录</label>
    <select id="notes-editor-section"></select>
  ...
  <div id="notes-editor-directory-fields" hidden>
    <label for="notes-directory-parent">上级目录</label>
    <select id="notes-directory-parent"></select>
    <label for="notes-directory-title">目录名称</label>
    ...
    <p class="notes-editor-create__hint">目录创建后，文章可以直接归入其中。</p>
  </div>

  <div id="notes-editor-rename-fields" hidden>
    <label for="notes-directory-rename-title">新的目录名称</label>
    <input id="notes-directory-rename-title" type="text" maxlength="120" autocomplete="off">
  </div>

  <button id="notes-editor-create-submit" class="md-button md-button--primary" type="button">继续</button>
